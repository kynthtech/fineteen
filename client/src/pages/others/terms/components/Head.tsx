    ...
    <div className="relative overflow-hidden py-16 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="relative mx-auto max-w-4xl space-y-6 text-center">
          <div className="relative z-10 mb-5 flex items-center justify-center space-x-2 text-sm text-gray-700 sm:mb-8 dark:text-gray-400">
            <Link
              to="/"
          ...
          <Grids variant="mask" />
          <h1 className="text-3xl leading-tight font-bold text-cyan-500 sm:text-5xl lg:text-6xl dark:text-white">
            Terms of Service
          </h1>
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-gray-600 sm:text-xl dark:text-gray-400">
            Please read these terms carefully before using the FinTeen platform.
