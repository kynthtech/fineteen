...
export const VideoPlayerTimeRange = ({
  ...
  <MediaTimeRange className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerTimeDisplay = ({
  ...
  <MediaTimeDisplay className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerVolumeRange = ({
  ...
  <MediaVolumeRange className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerPlayButton = ({
  ...
  <MediaPlayButton className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerSeekBackwardButton = ({
  ...
  <MediaSeekBackwardButton
    className={clsx("p-0.5 sm:p-2.5", className)}
    {...props}
  />
);
...
export const VideoPlayerMuteButton = ({
  ...
  <MediaMuteButton className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerContent = ({
  ...
  <video className={clsx("mt-0 mb-0", className)} {...props} />
);
